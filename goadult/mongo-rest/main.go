...
func main() {
	...
	mux.HandleFunc(pat.Get("/books"), addBooks(session))
	mux.HandleFunc(pat.Get("/books/:isbn"), bookByISBN(session))
	mux.HandleFunc(pat.Get("/books/:isbn"), updateBook(session))
	mux.HandleFunc(pat.Get("/books/:isbn"), deleteBook(session))
